...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("jingyue_control".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../jingyue_control-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\jingyue_control\flutter\build\windows\runner\Debug\ -o . -e ..\jingyue_control\flutter\build\windows\runner\Debug\jingyue_control.exe
