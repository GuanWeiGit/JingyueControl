...
pub const SCRAP_X11_REF_URL: &str = "https://jingyue.rqrt2122.cn/docs/en/manual/linux/#x11-required";
...
lazy_static::lazy_static! {
    static ref LOGIN_ERROR_MAP: Arc<HashMap<&'static str, LoginErrorMsgBox>> = {
        ...
        let map = HashMap::from([(LOGIN_SCREEN_WAYLAND, LoginErrorMsgBox{
            ...
            link: "https://jingyue.rqrt2122.cn/docs/en/manual/linux/#login-screen",
            try_again: true,
