...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the JingyueControl network..."),
        ...
        ("install_tip", "Due to UAC, JingyueControl can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install JingyueControl to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant JingyueControl \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant JingyueControl \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow JingyueControl to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [JingyueControl Input] service."),
        ...
        ("doc_mac_permission", "https://jingyue.rqrt2122.cn/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next JingyueControl application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("doc_fix_wayland", "https://jingyue.rqrt2122.cn/docs/en/client/linux/#x11-required"),
