...
// Because the url is always `https://api.jingyue.rqrt2122.cn/version/latest`.
#[tokio::main(flavor = "current_thread")]
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://jingyue.rqrt2122.cn".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    let url = url.to_ascii_lowercase();
    url.contains("jyyk.com/") || url.ends_with("jingyue.rqrt2122.cn")
}
...
mod tests {
    ...
    #[test]
    fn test_is_public() {
        // Test URLs containing "jingyue.rqrt2122.cn/"
        assert!(is_public("https://jingyue.rqrt2122.cn/"));
        assert!(is_public("https://jingyue.rqrt2122.cn/"));
        assert!(is_public("https://api.jingyue.rqrt2122.cn/v1"));
        assert!(is_public("https://API.RUSTDESK.COM/v1"));
        assert!(is_public("https://jingyue.rqrt2122.cn/path"));

        // Test URLs ending with "jingyue.rqrt2122.cn"
        assert!(is_public("jingyue.rqrt2122.cn"));
        assert!(is_public("https://jingyue.rqrt2122.cn"));
        assert!(is_public("https://RustDesk.com"));
        assert!(is_public("http://jingyue.rqrt2122.cn"));
        assert!(is_public("https://api.jingyue.rqrt2122.cn"));
        ...
        assert!(!is_public("https://jingyue.rqrt2122.cnputer.com"));
        assert!(!is_public("jingyue.rqrt2122.cnhello.com"));
    }
    ...
    fn test_should_use_tcp_proxy_for_api_url() {
        ...
        assert!(!should_use_tcp_proxy_for_api_url(
            "https://jingyue.rqrt2122.cn/api/login",
            "https://jingyue.rqrt2122.cn"
        ));
        assert!(!should_use_tcp_proxy_for_api_url(
            "https://admin.example.com/api/login",
            "not a url"
