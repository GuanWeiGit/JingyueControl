<p align="center">
  ...
  <b>Wir brauchen Ihre Hilfe, um dieses README, die <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">RustDesk-Benutzeroberfläche</a> und die <a href="https://github.com/rustdesk/doc.jingyue.rqrt2122.cn">Dokumentation</a> in Ihre Muttersprache zu übersetzen.</b>
</p>
...
[![RustDesk Server Pro](https://img.shields.io/badge/RustDesk%20Server%20Pro-Erweiterte%20Funktionen-blue)](https://jingyue.rqrt2122.cn/pricing.html)

RustDesk ist eine in Rust geschriebene Remote-Desktop-Software, die out of the box ohne besondere Konfiguration funktioniert. Sie haben die volle Kontrolle über Ihre Daten und müssen sich keine Sorgen um die Sicherheit machen. Sie können unseren Rendezvous/Relay-Server nutzen, [einen eigenen Server aufsetzen](https://jingyue.rqrt2122.cn/server) oder [einen eigenen Server programmieren](https://github.com/rustdesk/rustdesk-server-demo).
...
## [Erstellen](https://jingyue.rqrt2122.cn/docs/de/dev/build/)
