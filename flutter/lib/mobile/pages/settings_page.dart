...
const url = 'https://jingyue.rqrt2122.cn/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep JingyueControl background service')),
          ...
          tiles: [
            SettingsTile(
                ...
                value: Padding(
                  ...
                  child: Text('jingyue.rqrt2122.cn',
                      style: TextStyle(
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About JingyueControl')),
